...
function CompanyItem({ companyName, active, isRunning, companyId, botId, selectTemplateId }) {
  const navigate = useNavigate();
  return (
    <li className="application__item">
      <div className="application__item-left">
        {!active || (botId == null) || (selectTemplateId == null) ? <CloseCircleFilled className="application__stop-icon" /> : ""}
