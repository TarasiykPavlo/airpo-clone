    ...
    >
      <div className="products">
            ...
            <ul className="product__list-moonths-change">
              <label className="products__moonths-chang-item">
                <input
                  ...
                  name="moonth"
                  id="one-moonth"
                  onChange={(e) => setCheckedBtnMoonth(1)}
              ...
              <label className="products__moonths-chang-item">
                <input
                  ...
                  name="moonth"
                  id="three-moonth"
                  onChange={(e) => setCheckedBtnMoonth(3)}
              ...
              <label className="products__moonths-chang-item">
                <input
                  ...
                  name="moonth"
                  id="six-moonth"
                  onChange={(e) => setCheckedBtnMoonth(6)}
              ...
              <label className="products__moonths-chang-item">
                <input
                  ...
                  name="moonth"
                  id="twelve-moonth"
                  onChange={(e) => setCheckedBtnMoonth(12)}
        ...
        <div className="products__wrap">
          <ProductCard
            infoState={localStateProductCard[checkValuta][checkedBtnMoonth]}
            checkValuta={checkValuta}
