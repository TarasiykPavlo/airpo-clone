...
function ProductCard() {
  ...
  return (
    <div className={`product-card-wrapper ${changeCardSide ? "is-flipped" : ''}`}>
            ...
            <div className="product-card__wrap">
              ...
              <div className="product-card__info-price">
                ...
                <div className="product-card__price-action">
                  <s>$60</s> <span>$165</span> in 3 months
                </div>
          ...
          <div className="product-card__wrap back">
            <div className="product-card__head">
              ...
              <div className="product-card__subtitle">
                ...
                <p>
                  Telegram is a vast ocean with fish, and we are confident to
                  say that we have created that very fishing rod that saves your
                  time and money.
                </p>
              </div>
            </div>
