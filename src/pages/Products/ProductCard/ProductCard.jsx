  ...
  return (
    ...
    >
      <div className="product-card front">
        {!infoState.range[peopleCount].action ? (
          ""
        ) : (
          ...
          <div className="product-card__info-price">
            <div className="product-card__price">
              <span>
                ...
                {infoState.range[peopleCount].priceMoonth}
              </span>
              /mon*
            </div>
            {infoState.months === "1 month" ? (
                ''
            ) : (
              <div className="product-card__price-action">
                <s>{valutaCheckIcon}{infoState.range[peopleCount].price}</s>
                <span>{valutaCheckIcon}{infoState.range[peopleCount].priceAction}</span> 
                 in {infoState.months}
              </div>
            )}
